  ...
  <div style="margin-left: 10px">
    <el-row :gutter="24">
      ...
      <el-col :span="16" style="margin-top: 20px">
        ...
        <el-card shadow="hover" style="height: 280px" ref="echart"> </el-card>
  ...
  methods: {
    getTableData() {
      getHome().then((res) => {
        ...
        this.ehcartData.order.xAxis.data = order.data;
        let keyArrray = Object.keys(order.data);
        console.log(keyArrray);
...
const myEchartsOrder=echarts.init(this.Srefs.echarts)
