    ...
    <el-row :gutter="24">
      ...
      <el-col :span="16" style="margin-top: 20px">
        ...
        <div class="graph">
          ...
          <el-card>
            <Echart v-bind:chartData="ehcartData.order" style="height: 280px"></Echart>
          </el-card>
        </div>
      </el-col>
    </el-row>
  ...
  methods: {
    getTableData() {
      getHome().then((res) => {
        ...
        this.ehcartData.video.series.push({
          data: res.data.videoData,
          type: "pie",
        });

        const videoEcharts = echarts.init(this.$refs.videoEchart);
        videoEcharts.setOption(this.ehcartData.video);
      });
    },
  },
  mounted() {
